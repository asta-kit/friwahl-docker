		...
		$this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices = array(
			'initializeView' => array(
				'TYPO3\Flow\Aop\Advice\AfterAdvice' => array(
					new \TYPO3\Flow\Aop\Advice\AfterAdvice('AstaKit\FriWahl\AdminInterface\Utility\ViewInitializationAspect', 'assignDefaultVariablesForTemplateView', $objectManager, NULL),
				),
			),
		);
	}
	 ...
	 */
	 protected function initializeView(\TYPO3\Flow\Mvc\View\ViewInterface $view) {
		...
		try {
				...
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Mvc\Controller\ActionController', 'initializeView', $methodArguments);
				$result = $this->Flow_Aop_Proxy_invokeJoinPoint($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();

				if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['initializeView']['TYPO3\Flow\Aop\Advice\AfterAdvice'])) {
					$advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['initializeView']['TYPO3\Flow\Aop\Advice\AfterAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Mvc\Controller\ActionController', 'initializeView', $methodArguments, NULL, $result);
				...
				if (!$afterAdviceInvoked && isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['initializeView']['TYPO3\Flow\Aop\Advice\AfterAdvice'])) {
					$advices = $this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['initializeView']['TYPO3\Flow\Aop\Advice\AfterAdvice'];
					$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'TYPO3\Flow\Mvc\Controller\ActionController', 'initializeView', $methodArguments, NULL, NULL, $exception);
					foreach ($advices as $advice) {
						$advice->invoke($joinPoint);
					}
				}
