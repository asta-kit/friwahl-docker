 ...
 */
class ElectionController_Original extends \TYPO3\Flow\Mvc\Controller\ActionController {
 ...
 * Controller for managing elections.
 */
class ElectionController extends ElectionController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		...
		if ('AstaKit\FriWahl\AdminInterface\Controller\ElectionController' === get_class($this)) {
	 ...
	 */
	 protected function Flow_Aop_Proxy_buildMethodsAndAdvicesArray() {
		...
		$this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices = array(
			...
			'newPeriodAction' => array(
				'TYPO3\Flow\Aop\Advice\AroundAdvice' => array(
					new \TYPO3\Flow\Aop\Advice\AroundAdvice('TYPO3\Flow\Security\Aspect\PolicyEnforcementAspect', 'enforcePolicy', $objectManager, NULL),
				),
			),
			'createPeriodAction' => array(
				'TYPO3\Flow\Aop\Advice\AroundAdvice' => array(
					new \TYPO3\Flow\Aop\Advice\AroundAdvice('TYPO3\Flow\Security\Aspect\PolicyEnforcementAspect', 'enforcePolicy', $objectManager, NULL),
				),
			),
	 ...
	 public function indexAction() {
		...
		$result = parent::indexAction();
			...
			try {
				...
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'AstaKit\FriWahl\AdminInterface\Controller\ElectionController', 'indexAction', $methodArguments, $adviceChain);
	 ...
	 public function newAction() {
		...
		$result = parent::newAction();
			...
			try {
				...
				$adviceChain = $adviceChains['TYPO3\Flow\Aop\Advice\AroundAdvice'];
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'AstaKit\FriWahl\AdminInterface\Controller\ElectionController', 'newAction', $methodArguments, $adviceChain);
				$result = $adviceChain->proceed($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();
	 ...
	 * @return void
	 */
	 public function createAction(\AstaKit\FriWahl\Core\Domain\Model\Election $election) {

				// FIXME this can be removed again once Doctrine is fixed (see fixMethodsAndAdvicesArrayForDoctrineProxiesCode())
			$this->Flow_Aop_Proxy_fixMethodsAndAdvicesArrayForDoctrineProxies();
		if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['createAction'])) {
		$result = parent::createAction($election);
			...
			try {
				...
				$adviceChain = $adviceChains['TYPO3\Flow\Aop\Advice\AroundAdvice'];
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'AstaKit\FriWahl\AdminInterface\Controller\ElectionController', 'createAction', $methodArguments, $adviceChain);
				$result = $adviceChain->proceed($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();
	 ...
	 * @return void
	 */
	 public function showAction(\AstaKit\FriWahl\Core\Domain\Model\Election $election) {

				// FIXME this can be removed again once Doctrine is fixed (see fixMethodsAndAdvicesArrayForDoctrineProxiesCode())
			$this->Flow_Aop_Proxy_fixMethodsAndAdvicesArrayForDoctrineProxies();
		if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['showAction'])) {
		$result = parent::showAction($election);
			...
			try {
				...
				$adviceChain = $adviceChains['TYPO3\Flow\Aop\Advice\AroundAdvice'];
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'AstaKit\FriWahl\AdminInterface\Controller\ElectionController', 'showAction', $methodArguments, $adviceChain);
				$result = $adviceChain->proceed($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();
	 ...
	 * @param Election $election
	 */
	 public function newPeriodAction(\AstaKit\FriWahl\Core\Domain\Model\Election $election) {

				// FIXME this can be removed again once Doctrine is fixed (see fixMethodsAndAdvicesArrayForDoctrineProxiesCode())
			$this->Flow_Aop_Proxy_fixMethodsAndAdvicesArrayForDoctrineProxies();
		if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['newPeriodAction'])) {
		$result = parent::newPeriodAction($election);

		} else {
			$this->Flow_Aop_Proxy_methodIsInAdviceMode['newPeriodAction'] = TRUE;
			try {
				...
				$adviceChains = $this->Flow_Aop_Proxy_getAdviceChains('newPeriodAction');
				$adviceChain = $adviceChains['TYPO3\Flow\Aop\Advice\AroundAdvice'];
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'AstaKit\FriWahl\AdminInterface\Controller\ElectionController', 'newPeriodAction', $methodArguments, $adviceChain);
				$result = $adviceChain->proceed($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();

			} catch (\Exception $e) {
				unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['newPeriodAction']);
				throw $e;
			}
			unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['newPeriodAction']);
		}
	 ...
	 * @return void
	 */
	 public function createPeriodAction(\AstaKit\FriWahl\Core\Domain\Model\ElectionPeriod $period) {

				// FIXME this can be removed again once Doctrine is fixed (see fixMethodsAndAdvicesArrayForDoctrineProxiesCode())
			$this->Flow_Aop_Proxy_fixMethodsAndAdvicesArrayForDoctrineProxies();
		if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['createPeriodAction'])) {
		$result = parent::createPeriodAction($period);

		} else {
			$this->Flow_Aop_Proxy_methodIsInAdviceMode['createPeriodAction'] = TRUE;
			try {
			
					$methodArguments = array();

				$methodArguments['period'] = $period;
			
				$adviceChains = $this->Flow_Aop_Proxy_getAdviceChains('createPeriodAction');
				$adviceChain = $adviceChains['TYPO3\Flow\Aop\Advice\AroundAdvice'];
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'AstaKit\FriWahl\AdminInterface\Controller\ElectionController', 'createPeriodAction', $methodArguments, $adviceChain);
				$result = $adviceChain->proceed($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();

			} catch (\Exception $e) {
				unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['createPeriodAction']);
				throw $e;
			}
			unset($this->Flow_Aop_Proxy_methodIsInAdviceMode['createPeriodAction']);
		}
	 ...
	 protected function errorAction() {
		...
		$result = parent::errorAction();
			...
			try {
				...
				$adviceChain = $adviceChains['TYPO3\Flow\Aop\Advice\AroundAdvice'];
				$adviceChain->rewind();
				$joinPoint = new \TYPO3\Flow\Aop\JoinPoint($this, 'AstaKit\FriWahl\AdminInterface\Controller\ElectionController', 'errorAction', $methodArguments, $adviceChain);
				$result = $adviceChain->proceed($joinPoint);
				$methodArguments = $joinPoint->getMethodArguments();
	...
	$reflectedClass = new \ReflectionClass('AstaKit\FriWahl\AdminInterface\Controller\ElectionController');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if (isset($this->Flow_Injected_Properties) && is_array($this->Flow_Injected_Properties) && in_array($propertyName, $this->Flow_Injected_Properties)) continue;
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('AstaKit\FriWahl\AdminInterface\Controller\ElectionController', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('AstaKit\FriWahl\AdminInterface\Controller\ElectionController', $propertyName, 'var');
