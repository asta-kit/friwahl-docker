...
/**
 * Commits queued votes for the given voter
 *
 * @author Andreas Wolf <andreas.wolf@usta.de>
 */
class CommitQueueElementCommand extends VoterRelatedCommand {
	...
	public function process(array $parameters = NULL) {
		...
		$this->votingService->commitPendingVotesForVoter($this->ballotBox, $voter);
	}
